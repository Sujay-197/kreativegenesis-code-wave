...
export default function Builder() {
  ...
  return (
    <div className="min-h-screen bg-forge-dark flex flex-col relative overflow-hidden">
          ...
          <AnimatePresence mode="wait">
                ...
                <div className="w-full max-w-3xl">
                  ...
                  <div className="flex flex-col gap-6">
                    ...
                    <div className="flex-[1]">
                      <p className="text-sm text-forge-emerald mb-2 ml-[46%]">ALSO TRY</p>
                      <motion.button
                        whileHover={{ y: -4, scale: 1.01 }}
                        whileTap={{ scale: 0.99 }}
                        transition={{ duration: 0.2 }}
                        onClick={() => selectMode('expert')}
                        className="group relative w-50% text-left px-8 py-2 rounded-2xl border-2 border-forge-emerald/30 hover:border-forge-emerald/60 bg-forge-surface hover:bg-forge-surface-hover transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-forge-accent focus-visible:ring-offset-2 focus-visible:ring-offset-forge-dark cursor-pointer ml-[36%]"
                      >
                        <div className="flex justify-center items-center gap-2 px-3 py-1 rounded-full text-xs font-semibold mb-1 bg-forge-emerald/15 text-forge-emerald w-fit mx-auto">
                          <Code2 size={10} />
                          For developers
                        </div>
                        <h2 className="font-heading text-2xl font-bold text-white mb-1">Expert Mode</h2>
                      </motion.button>
                    </div>
                  </div>
                </div>
            ...
            {(stage === 'chat' || stage === 'summary') && (
              ...
              >
                ...
                <div
                  className={`flex-1 flex flex-col overflow-hidden transition-all duration-500 ${questionCount > 0 ? 'border-r border-forge-border' : ''
                    }`}
                >
