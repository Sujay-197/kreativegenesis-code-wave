...
8. NEVER use href="#" — always use href="javascript:void(0)" with onclick handlers. Plain href="#" causes navigation issues in iframe previews.
9. Populate sample data with realistic domain-specific values (real names, realistic amounts, proper categories). Never use generic placeholder text like "Record 1", "Record 2".
10. Modal form fields must match the table columns — not generic Name/Status/Value fields.
