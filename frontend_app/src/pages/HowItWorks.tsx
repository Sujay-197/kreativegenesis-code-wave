...
const detailedSteps = [
  ...
  },
  {
    ...
    body: 'Before generating anything, InNovus presents a clear summary of what it understood. In Simple Mode this reads like a plain English description. In Expert Mode it reads like a technical spec. You can correct anything before proceeding.',
  },
  {
    icon: Download,
    number: '05',
      ...
      <main>
        <section className="pt-32 pb-16 bg-forge-dark">
          <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
            ...
            >
              The intelligence layer before generation is what makes InNovus different. Here's exactly what happens when you build.
            </motion.p>
          </div>
        </section>
